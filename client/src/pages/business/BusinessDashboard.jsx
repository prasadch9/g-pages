          ...
          {places.map((place) => (
            <div key={place._id} className="flex flex-wrap items-center justify-between gap-3 p-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Link to={(place.category?.slug || place.category?.name || '').toLowerCase() === 'solar' ? `/business/listings/${place._id}/edit/solar` : `/business/listings/${place._id}/edit`} className="rounded border border-line px-3 py-1.5 text-xs font-semibold text-ink/70 hover:border-ink/40 hover:text-ink">Edit</Link>
